...
//---------------------------------------------------------------------
{
    ...
    if(arguments.size()==1)
    {
        ...
        //    std::cout<<"############# opacity: "<<m_vServer.opacity<<" - "<< ss.str()<<"###############"<<std::endl;
    ...
    else //if(arguments.size()==1)
    {
        ...
        for (i=0; i<arguments.size(); i++)
        {
            ...
            else if (arguments[i]=="--zoom")
            {
                ...
                ss3<<arguments[++i];
                ss3>>m_vServer.zoom;
                viewParameter["zoom"]=ss3.str();
                
                std::cout<<"############# zoom: "<<m_vServer.zoom<<" - "<< viewParameter["zoom"]<<"###############"<<std::endl;
