...
errorCode=VI_SetAtt(&envVI1,VI_SET_FILEPATH,"mrvbt16.ascii");
...
errorCode=VF_SetAtt(&envVF1,VF_SET_FILEVBT,"mrvbt16.bin");
...
errorCode=VV_SetAtt(&envVV1,VV_SET_FILEVBT,"mrvbt16.bin");
